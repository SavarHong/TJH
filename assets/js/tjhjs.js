...
+ function($) {
    ...
    append: function(column) {
        this.indexImage += 1;
        var html = '', index = this.getIndex(), imgUrl = this.rootImage + "activity-show-product" + index + ".jpg";
    ...
    create: function() {
        ...
        for (start; start < this.columnNumber; start+=1) {
            htmlColumn = htmlColumn + '<span id="waterFallColumn_'+ start +'" class="column" style="width:'+ this.columnWidth + ';">'+
                function() {
                    var html = '', i = 0;
                    for (i=0; i<5; i+=1) {
        ...
        htmlColumn += '<span id="waterFallDetect" class="column" style="width:'+ this.columnWidth + ';"></span>';

        this.container.html(htmlColumn);
    ...
    refresh: function() {
        ...
        if (arrHtml && arrHtml.length !== 0) {
            ...
            for (newStart; newStart < this.columnNumber; newStart+=1) {
                htmlColumn = htmlColumn + '<span id="waterFallColumn_'+ newStart +'" class="column" style="width:'+ this.columnWidth + ';">'+
                    function() {
                        var html = '', i = 0;
                        for (i=0; i<line; i+=1) {
    ...
    scroll: function() {
        var self = this;
        self.body.on("scroll", function(){
            // 为提高性能，滚动前后距离大于100像素再处理
            var scrollTop = $(".content").scrollTop();
            if (!this.loadFinish && Math.abs(scrollTop - self.scrollTop) > 200) {
